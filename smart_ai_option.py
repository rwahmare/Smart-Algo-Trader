...
# ==========================================
# 🛑 GitHub Secrets मधून सिक्रेट टेलिग्राम डिटेल्स घेणे
# ==========================================
...
if len(trade_signals) == 0:
    print("सध्या कोणताही मजबूत CE किंवा PE सिग्नल नाही. मार्केट साईडवेज असू शकते.")
else:
...
if len(trade_signals) == 0:
    print("सध्या कोणताही मजबूत CE किंवा PE सिग्नल नाही. मार्केट साईडवेज असू शकते.")
    # टेस्टिंगसाठी ही नवीन लाईन ॲड केली आहे:
    send_telegram_message("🤖 AI Scanner Active: 5-Min Scan पूर्ण झाला, पण सध्या कोणताही सिग्नल नाही.")
else:
    for signal in trade_signals:
        print(signal)
    print("\n✅ सर्व सिग्नल्स तुमच्या टेलिग्रामवर यशस्वीरीत्या पाठवले आहेत!")
